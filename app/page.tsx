...
function Setting({label,icon,detail,toggle,checked,onChange}:{label:string;icon:string;detail:string;toggle?:boolean;checked?:boolean;onChange?:(v:boolean)=>void}){return <div className="setting-row"><span className="setting-icon">{icon}</span><span><b>{label}</b><small>{detail}</small></span>{toggle?<input type="checkbox" checked={checked} onChange={e=>onChange?.(e.target.checked)}/>:<i>›</i>}</div>}
 ...
 const css=`*{box-sizing:border-box}html,body{margin:0;padding:0;background:#1b1b2e;color:#f7f4f7;font-family:Inter,Arial,sans-serif}.app{min-height:100svh;background:#1b1b2e;color:#f7f4f7}.page-head{padding:42px 28px 26px;background:#1b1b2e}.page-head h1,.page-head h2,.voice h2{font-family:Georgia,'Times New Roman',serif;font-weight:400;letter-spacing:-1.5px;color:#fff}.page-head h1{font-size:42px;line-height:1.05;margin:0 0 20px}.page-head:after{content:"";display:block;width:100%;height:1px;background:rgba(255,255,255,.7);margin-top:24px}.page-head p,.page-head .subtitle{font-family:Georgia,'Times New Roman',serif;font-size:19px;line-height:1.55;color:#eeeaf0}.card,.panel,.tool,.settings-card,.profile-card,.chat-card,.voice,.auth-card{background:linear-gradient(145deg,#9db9d9,#d9c9df);border:1px solid rgba(255,255,255,.35);border-radius:24px;box-shadow:0 18px 45px rgba(0,0,0,.28);color:#171722}.card:hover,.panel:hover,.tool:hover{transform:translateY(-3px);transition:.25s}.button,button{border:0;border-radius:999px;background:linear-gradient(90deg,#8b4dff,#c74fdc);color:#fff;padding:13px 22px;font-weight:600;box-shadow:0 8px 20px rgba(139,77,255,.25)}input,textarea,select{background:rgba(255,255,255,.88);border:1px solid rgba(255,255,255,.7);border-radius:14px;color:#171722;padding:12px;font:inherit}.voice{background:linear-gradient(145deg,#9bb8d9,#d8b9d5)}.voice h2{font-size:34px}.chat,.chat-home{background:#1b1b2e}.message,.bubble{border-radius:20px;background:linear-gradient(135deg,#a8c3e2,#d9bddd);color:#171722}.nav,.sidebar{background:#171726;border-right:1px solid rgba(255,255,255,.12)}.nav button,.sidebar button{background:transparent;box-shadow:none;color:#eee}.nav button:hover,.sidebar button:hover{background:rgba(255,255,255,.08)}@media(max-width:600px){.page-head{padding:30px 20px 20px}.page-head h1{font-size:31px}.voice h2{font-size:34px}.card,.panel,.tool,.settings-card,.profile-card,.chat-card,.voice,.auth-card{border-radius:20px}}`
