...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><head><meta name="google-site-verification" content="JrQoW2tLRzdfOBhQMiw8WvtBnJ-ewADF62V0N7tqSxQ"/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(structuredData)}}/></head><body><PWARegister/><PreferencesBridge/><ProfileButtonBridge/>{children}<MahBuddyNav/></body></html>}
