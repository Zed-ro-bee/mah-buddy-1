...
import SignInRecorder from "../components/sign-in-recorder";
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><head><meta name="google-site-verification" content="m4i4Niqk3fDJdwtshu3P8cXUgUNeIGQN0bAMeyEblbA"/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(structuredData)}}/></head><body><PWARegister/><PreferencesBridge/><ProfileButtonBridge/><SignInRecorder/>{children}<MahBuddyNav/></body></html>}
