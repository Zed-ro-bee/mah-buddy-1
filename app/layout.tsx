...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><head><meta name="google-site-verification" content="7FTNF2edvzDEmRbbvhFwv6h6MMWWvYwvLxldLDY-syQ"/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(structuredData)}}/></head><body><PWARegister/><PreferencesBridge/><ProfileButtonBridge/>{children}<MahBuddyNav/></body></html>}
